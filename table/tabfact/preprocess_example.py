...
# --csv_dir=/home/ousuixin/Desktop/Table-Fact-Checking-master/data/all_csv 
# --used_csv_ids=/home/ousuixin/Desktop/SASP/data/tabfact/csv_ids.txt
# --data_dict_file=/home/ousuixin/Desktop/SASP/data/tabfact/tables.jsonl
# --min_frac_for_props=0.25
# --corenlp_path=/home/ousuixin/Downloads/stanford-corenlp-4.2.0

# --example_path_untagged=/home/ousuixin/Desktop/Table-Fact-Checking-master/tokenized_data/train_examples.json
# --example_path=/home/ousuixin/Desktop/SASP/data/tabfact/examples.tagged
# --processed_example_path=/home/ousuixin/Desktop/SASP/data/tabfact/data_shard

parser = argparse.ArgumentParser(description='read params')
parser.add_argument('--csv_dir', help='all csv folder')
parser.add_argument('--used_csv_ids', help='csv ids to be processed')
parser.add_argument('--data_dict_file', help='csv data saved as dict in the file')
...
parser.add_argument('--example_path_untagged', help='untagged question example path')
parser.add_argument('--example_path', help='tagged question example path')
parser.add_argument('--processed_example_path', help='tagged question example path')
